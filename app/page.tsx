...
export default function Dashboard() {
  ...
  return <main className="shell">
    ...
    <section className="hero"><div><p className="eyebrow"><span/> RECRUTEMENT 2026–2027</p><h1>Les meilleures offres.<br/><em>Avant tout le monde.</em></h1><p className="subtitle">Stages, alternances et premiers emplois tech en France, détectés à la source, surveillés toutes les 10 minutes et envoyés sur Slack.</p></div><div className="freshness"><span className="pulse"/><div><strong>Surveillance active</strong><small>Synchronisation toutes les 10 min</small></div></div></section>
