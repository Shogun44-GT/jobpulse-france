...
import { Bookmark, BriefcaseBusiness, Check, ChevronDown, Clock3, ExternalLink, MapPin, Search, Settings2, SlidersHorizontal, Sparkles, Zap } from "lucide-react";
...
export default function Dashboard() {
  ...
  return <main className="shell">
    <nav className="nav"><div className="brand"><span className="brandMark"><Zap size={19} fill="currentColor" /></span><span>JobPulse</span><small>FRANCE</small></div><div className="navActions"><button className="ghost"><BriefcaseBusiness size={16}/> Candidatures</button><button className="primary"><span className="slack">✣</span> Connecter Slack</button><button className="iconButton" aria-label="Paramètres"><Settings2 size={18}/></button></div></nav>
    ...
    <section className="cta"><Sparkles size={22}/><div><strong>Transforme l’alerte en candidature</strong><p>Connecte ton profil pour recevoir uniquement les offres pertinentes et générer une accroche personnalisée.</p></div><button>Créer mon profil</button></section>
  </main>;
}
